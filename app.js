    ...
    class WikiReq {
      ...
      constructor(actionType, format, origin, prop, redirects, inprop, exsentences, exintro, explaintext, endpoint){
        ...
        this.endpoint = endpoint === undefined ? 'https://en.wikipedia.org/w/api.php' : endpoint;
    ...
    function getSR_Input(obj){
      ...
      function getRandomArticles(){
        ...
        if(wr.random(5)){
          ...
          document.getElementById('infoTextDiv').style = "visibility: hidden;";
          document.getElementById('infoText').innerHTML = "some random articles for you:";
    ...
    document.getElementById('randomBtn').addEventListener('click', getRandomArticles);
